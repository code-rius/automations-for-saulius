...
# Find all DIR_ELEKTRINE_X entries in .env file
elektrine_dirs = []
i = 1
while True:
...
for elektrine_dir in elektrine_dirs:
    ...
    # Look for txt file with the same name as the last folder
    ...
    print(f"Processing PDF files in directory: {folder_path}")
    ...
    print(f"Included info from {info_txt_path}")
